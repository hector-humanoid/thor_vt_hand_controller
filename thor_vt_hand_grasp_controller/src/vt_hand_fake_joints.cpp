...
{
    hand_joints_.name.resize(2);
    hand_joints_.position.resize(2);
    hand_joints_.velocity.resize(2);
    hand_joints_.effort.resize(2);
    ...
    hand_joints_.name[0] = hand + "_f0_j1";
    hand_joints_.name[1] = hand + "_f1_j1";
...
{
    // Create publisher
    ros::init(argc, argv, "vt_hand_fake_joints");
